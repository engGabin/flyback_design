...
class PageBase(QWidget):
    ...
    def __init__(self, ds, res, title: str = "", parent=None):
        ...
        # Création du widget interne qui contiendra les éléments
        inner_widget = QWidget()
        # Le widget interne doit avoir un fond transparent pour hériter de celui de l'application
        inner_widget.setStyleSheet("background-color: transparent;") 
        scroll.setWidget(inner_widget)

        # Layout du widget interne
        ...
        inner_layout.addLayout(self._content_layout)
